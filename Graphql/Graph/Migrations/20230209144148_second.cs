    ...
    public partial class second : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DeleteData(
                table: "Superheroes",
                keyColumn: "Id",
                keyValue: new Guid("5ac16d0f-33f4-47d2-b6dc-a563701ac670"));

            migrationBuilder.DeleteData(
                table: "Superheroes",
                keyColumn: "Id",
                keyValue: new Guid("acc77c94-6087-4324-b56a-9b769e4c15a0"));

            migrationBuilder.DeleteData(
                table: "Superheroes",
                keyColumn: "Id",
                keyValue: new Guid("da66fd31-c506-41c7-8858-5d6506476a19"));
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Abilities_Superheroes_SuperheroId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1f6e4477-84d9-4d82-8860-d2ce3a0e2956"), 32, "Batman was originally introduced as a ruthless vigilante who frequently killed or maimed criminals, but evolved into a character with a stringent moral code and strong sense of justice. Unlike most superheroes, Batman does not possess any superpowers, instead relying on his intellect, fighting skills, and wealth.", "Batman" },
                    { new Guid("61f2d09d-cb5f-4084-8773-f14140ec0466"), 21, "Luke Skywalker was a Tatooine farmboy who rose from humble beginnings to become one of the greatest Jedi the galaxy has ever known. Along with his friends Princess Leia and Han Solo, Luke battled the evil Empire, discovered the truth of his parentage, and ended the tyranny of the Sith.", "Luke Skywalker" },
                    { new Guid("c98e94b0-2729-4bbd-b450-bd7c21092906"), 26, "Black Widow, real name Natasha Romanoff, is a trained female secret agent and superhero that appears in Marvel Comics. Associated with the superhero teams S.H.I.E.L.D. and the Avengers, Black Widow makes up for her lack of superpowers with world class training as an athlete, acrobat, and expert martial artist and weapon specialist.", "Black Widow" }
                });

            migrationBuilder.InsertData(
                table: "Abilities",
                columns: new[] { "Id", "Name", "SuperheroId" },
                values: new object[,]
                {
                    { new Guid("1ce4a057-576c-4ecf-81f2-c786de651b37"), "Intellect.", new Guid("1f6e4477-84d9-4d82-8860-d2ce3a0e2956") },
                    { new Guid("2a5040d5-0221-4141-86ff-8bae61bd38c5"), "Infiltration", new Guid("c98e94b0-2729-4bbd-b450-bd7c21092906") },
                    { new Guid("2c7e0d51-5604-4628-8f8c-7b03b271e34b"), "Fighting", new Guid("1f6e4477-84d9-4d82-8860-d2ce3a0e2956") },
                    { new Guid("39369814-f8a0-4131-b691-136df41e197a"), "Deflect blaster power.", new Guid("61f2d09d-cb5f-4084-8773-f14140ec0466") },
                    { new Guid("8c813a1b-e026-4c95-96ce-8ecc0b4a8c6e"), "Wealth.", new Guid("1f6e4477-84d9-4d82-8860-d2ce3a0e2956") },
                    { new Guid("8ea56a05-c379-417c-8a84-99d7b354efc9"), "Subterfuge", new Guid("c98e94b0-2729-4bbd-b450-bd7c21092906") },
                    { new Guid("dce986e6-2361-4765-8400-e998b96275d4"), "Espionage", new Guid("c98e94b0-2729-4bbd-b450-bd7c21092906") }
                });

            migrationBuilder.CreateIndex(
                name: "IX_Abilities_SuperheroId",
                table: "Abilities",
                column: "SuperheroId");
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DeleteData(
                table: "Superheroes",
                keyColumn: "Id",
                keyValue: new Guid("1f6e4477-84d9-4d82-8860-d2ce3a0e2956"));

            migrationBuilder.DeleteData(
                table: "Superheroes",
                keyColumn: "Id",
                keyValue: new Guid("61f2d09d-cb5f-4084-8773-f14140ec0466"));

            migrationBuilder.DeleteData(
                table: "Superheroes",
                keyColumn: "Id",
                keyValue: new Guid("c98e94b0-2729-4bbd-b450-bd7c21092906"));
